...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_main_ada_callpython_matplotlib" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#ee60b6b5#;
   pragma Export (C, u00001, "main_ada_callpython_matplotlibB");
   ...
   u00127 : constant Version_32 := 16#927a893f#;
   pragma Export (C, u00127, "ada__text_ioB");
   u00128 : constant Version_32 := 16#5194351e#;
   pragma Export (C, u00128, "ada__text_ioS");
   u00129 : constant Version_32 := 16#10558b11#;
   ...
   u00147 : constant Version_32 := 16#d446a5b4#;
   pragma Export (C, u00147, "pkg_ada_datetime_stampB");
   u00148 : constant Version_32 := 16#b2313c2f#;
   pragma Export (C, u00148, "pkg_ada_datetime_stampS");
   u00149 : constant Version_32 := 16#9a2e29aa#;
   pragma Export (C, u00149, "ada__calendarB");
   u00150 : constant Version_32 := 16#c4f07049#;
   pragma Export (C, u00150, "ada__calendarS");
   u00151 : constant Version_32 := 16#10f667b3#;
   pragma Export (C, u00151, "ada__calendar__formattingB");
   u00152 : constant Version_32 := 16#f87a094f#;
   pragma Export (C, u00152, "ada__calendar__formattingS");
   u00153 : constant Version_32 := 16#e3cca715#;
   pragma Export (C, u00153, "ada__calendar__time_zonesB");
   u00154 : constant Version_32 := 16#f21593b3#;
   pragma Export (C, u00154, "ada__calendar__time_zonesS");
   ...
   u00159 : constant Version_32 := 16#c2ca0511#;
   pragma Export (C, u00159, "system__val_realB");
   u00160 : constant Version_32 := 16#b81c9b15#;
   pragma Export (C, u00160, "system__val_realS");
   u00161 : constant Version_32 := 16#b2a569d2#;
   pragma Export (C, u00161, "system__exn_llfB");
   u00162 : constant Version_32 := 16#fa4b57d8#;
   pragma Export (C, u00162, "system__exn_llfS");
   u00163 : constant Version_32 := 16#42a257f7#;
   ...
   u00165 : constant Version_32 := 16#a6c9af38#;
   pragma Export (C, u00165, "system__float_controlS");
   u00166 : constant Version_32 := 16#16458a73#;
   pragma Export (C, u00166, "system__powten_tableS");
   u00167 : constant Version_32 := 16#a3db8081#;
   pragma Export (C, u00167, "ada__strings__unboundedB");
   u00168 : constant Version_32 := 16#f39c7224#;
   pragma Export (C, u00168, "ada__strings__unboundedS");
   u00169 : constant Version_32 := 16#60da0992#;
   ...
   u00177 : constant Version_32 := 16#d96e3c40#;
   pragma Export (C, u00177, "system__finalization_mastersB");
   u00178 : constant Version_32 := 16#1dc9d5ce#;
   ...
   u00180 : constant Version_32 := 16#b3ec9def#;
   ...
   u00182 : constant Version_32 := 16#65d872a9#;
   pragma Export (C, u00182, "system__storage_poolsS");
   u00183 : constant Version_32 := 16#84042202#;
   ...
   u00185 : constant Version_32 := 16#020a3f4d#;
   pragma Export (C, u00185, "system__atomic_countersB");
   u00186 : constant Version_32 := 16#f269c189#;
   pragma Export (C, u00186, "system__atomic_countersS");
   u00187 : constant Version_32 := 16#039168f8#;
   pragma Export (C, u00187, "system__stream_attributesB");
   u00188 : constant Version_32 := 16#8bc30a4e#;
   pragma Export (C, u00188, "system__stream_attributesS");
   u00189 : constant Version_32 := 16#276453b7#;
   pragma Export (C, u00189, "system__img_lldB");
   u00190 : constant Version_32 := 16#b517e56d#;
   pragma Export (C, u00190, "system__img_lldS");
   u00191 : constant Version_32 := 16#bd3715ff#;
   pragma Export (C, u00191, "system__img_decB");
   u00192 : constant Version_32 := 16#e818e5df#;
   pragma Export (C, u00192, "system__img_decS");
   u00193 : constant Version_32 := 16#0d3bf8e6#;
   pragma Export (C, u00193, "pkg_ada_realtime_delaysB");
   u00194 : constant Version_32 := 16#650f8c05#;
   pragma Export (C, u00194, "pkg_ada_realtime_delaysS");
   u00195 : constant Version_32 := 16#2353cf5b#;
